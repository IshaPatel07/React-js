...
export default function Photos() {
  ...
  const handleSearch = () => {
    setProducts(
      products.filter(
        (product, i) =>
          product.title.toLowerCase().includes(search.toLowerCase()) || // search me small alphabet dal k bhi search kr sakte hai
          product.category.toLowerCase().includes(search.toLowerCase()),// category bhi search kr sakte hai 
      ),
    );
  };
